...
public class TweetAnalysis {
    ...
    /*
     * public static void visuals(){ countdown();
     * 
     * new Sound("Intro"); sleep(1000);
     * System.out.println("\n\n\n\n\n\n\n\n\t\t\t\t\tσηє ρєяѕση..."); sleep(4800);
     * System.out.print('\u000C');
     * 
     * System.out.println("\n\n\n\n\n\n\n\n\t\t\t\t\tειεvεη үεαяs..."); sleep(4800);
     * System.out.print('\u000C');
     * 
     * System.out.
     * println("\n\n\n\n\n\n\n\n\t\t\t\t\t𝟛𝟙,𝟠𝟘𝟡 𝓇𝒶𝓌 𝓣𝓌𝑒𝑒𝓉𝓈...");
     * sleep(4800); System.out.print('\u000C');
     * 
     * System.out.
     * println("\n\n\n\n\n\n\n\n\t\t\t\t𝕋ℍ𝔼 𝔻𝕆ℕ𝔸𝕃𝔻 𝕋ℝ𝕌𝕄ℙ 𝕋𝕎𝔼𝔼𝕋 𝔸ℕ𝔸𝕃𝕐𝕊𝕀𝕊"
     * ); sleep(2300);
     ...
     * System.out.println("\t\t\t\t⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠹⣿⣿⡇⠄⠄⠸⣿⡄⠄⠈⠁⠄⠄⠄⠄⠄⣿");
     * System.out.println("\t\t\t\t⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⢻⣿⡇⠄⠄⠄⢹⣧⠄⠄⠄⠄⠄⠄⠄⠄⠘");
     * System.out.println("\t\t\t\t               \"ｃｈｉｎａ\""); sleep(2000);
     * System.out.print('\u000C');
     * 
     * new Sound("Rap"); System.out.println("\n\n\n\n\n\n\n\n\t\t\t\t\tBEGIN!");
     * sleep(500); int obamaIndex = findOccurence("obama");
     * System.out.println(list.get(obamaIndex).getCount()); sleep(3500); }
     */
}