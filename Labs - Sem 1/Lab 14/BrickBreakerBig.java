...
public class BrickBreakerBig extends JPanel implements Runnable, KeyListener/*, ActionListener*/{
    //Initialize Ball
    ...
    public BrickBreakerBig(){
    }

    public static void main(String[] args){
        JFrame frame = new JFrame();
        BrickBreakerBig game = new BrickBreakerBig();
    ...
    public void paint(Graphics g){
        ...
        g.setFont(infoFont);
        //Show Score
        g.drawString("Score: " + count +"/18", 50, 600);
        //Show Time
        ...
        //Show my name
        g.setColor(Color.white);
        g.drawString("Made by Jaewon Lee", 50, 825);
    }
